...
<body>
  ...
  <p style="text-align:center;">Aquí podrás holaaaaaaaaa encontrar información sobre pokemones.</p>
...
<form align="center" action="consultas/consulta_tipo.php" method="post">
  ...
  <h3 align="center"> ¿Quieres un Pokemón por tipo y/o nombre?</h3>
  ...
  require("config/conexion.php");
  $result = $db -> prepare("SELECT DISTINCT tipo FROM pokedex;");
  $result -> execute();
  $dataCollected = $result -> fetchAll();
  ?>
